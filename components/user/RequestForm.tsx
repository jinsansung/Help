...
const SHEETS_WEBHOOK_URL = process.env.NEXT_PUBLIC_SHEETS_WEBHOOK_URL || 'https://script.google.com/macros/s/AKfycbxxy_tvYPwMAL_GvFBWp5dFtDgJDnLDetmhYXKndlIaeKN2FgX_9bMPFk4WmpQ5fWdP/exec';
